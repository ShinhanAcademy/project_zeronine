 ...
 * 
 * import com.amazonaws.AmazonServiceException; import
 ...
 * 
 * @Service public class S3Upload {
 * 
 * //@Value("${cloud.aws.s3.bucket}") private String bucket = "zeronine";
 * 
 ...
 * 
 * public String upload(MultipartFile multipartFile, String uuid, String
 * extension) throws AmazonServiceException, SdkClientException, IOException {
 * ObjectMetadata objMeta = new ObjectMetadata(); try {
 * objMeta.setContentLength(multipartFile.getInputStream().available());
 * 
 ...
 * 
 * String s3FileName = uuid + '.' + extension; amazonS3.putObject(bucket,
 * s3FileName, multipartFile.getInputStream(), objMeta); return
