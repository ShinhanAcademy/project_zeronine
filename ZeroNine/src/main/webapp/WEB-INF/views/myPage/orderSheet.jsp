				...
				<div class="orderinfo_box">
					...
					<div class="orderinfo_boxtext">
						<div class="infotext_space">
							<div class="img_wrap">
								<img src="${item.imagePath}" alt="product image" style="width:50px; hegiht: 50px;">
							</div>
							...
							<div class="infotext_space_right">
								...
								value="${item.price*item.pCount}" maxFractionDigits="3"></fmt:formatNumber>원</span>
							</div>
						</div>
						<div class="jul"></div>
						<!--  orderinfo_boxtext -->
					...
					<div class="tw_wb">
						<div class="orderpinfo">
							<div class="od1">
								...
								<div class="odd">
									<input type="text" class="odd_input" value="${customerInfo.customerName }" readonly>
								</div>
							...
							<div class="od1">
								...
								<div class="odd">
									<input type="text" class="odd_input" value="${customerInfo.phoneNumber }" readonly>
								</div>
							...
							<div class="od1">
								...
								<div class="odd">
									<input type="text" class="odd_input" value="${customerInfo.email }" readonly>
								</div>
